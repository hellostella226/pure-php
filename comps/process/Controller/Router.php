...
class Router
{
    ...
    /**
     * Store a before middleware route and a handling function to be executed when accessed using one of the specified method.
     *
    ...
    /**
     * Store a route and a handling function to be executed when accessed using one of the specified method.
     *
     * @param string $methods Allowed methods, | delimited
     * @param string $pattern A route pattern such as /about/system
     * @param object|callable $fn The handling function to be executed
    ...
    /**
     * Set a Default Lookup Namespace for Callable method.
     *
    ...
    public function getCurrentUri()
    {
        ...
        $uri = substr(rawurldecode($routeUrl . $_SERVER['REQUEST_URI']), strlen($this->getBasePath()));
