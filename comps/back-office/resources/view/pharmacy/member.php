<div class="container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="container-fluid table-responsive">
            <div class="row mb-3">
                ...
                <div class="col-sm-11 mt-3" style="text-align:right;">
                    <button class="btn btn-primary excel-down-btn" data-list="front" data-id="adminTable" data-hidden="13" data-name="얼리큐_회원정보" type="button">Excel</button>
                </div>
            </div>
            <table class="table table-hover table-bordered text-nowrap sortable" style="width:100%">
                ...
                <tr>
                    ...
                    <th scope="col" class="no-sort">이탈시점</th>
        ...
        <div id="MembersEditModal" class="modal fade updateMembers" tabindex="-1" data-bs-backdrop="static" role="dialog"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="UsersIdx" name="UsersIdx" class="required-value" value="">
...
<script src="/b***-*abc/resources/js/pharmacy/Members.js"></script>