                ...
                <div class="container-fluid table-responsive">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-11 mt-3" style="text-align:right;">
                            <button class="btn btn-primary excel-down-btn" data-list="front" data-id="adminTable" data-hidden="7" data-name="얼리큐_**상품관리" type="button">Excel</button>
                        </div>
                    </div>
...
<script src="/b***-*abc/resources/js/pharmacy/insuranceItem.js"></script>