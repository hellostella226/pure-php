<div class="container-fluid">
    <div class="container-fluid" style="margin: 10px">
        <h3 class="text-center">상품그룹관리</h3>
    </div>
    <hr class="mb-3">
        ...
        <div class="row mb-1">
            <div class="col-md-1" id="searchDiv">
                <select id="searchColumn" class="form-select form-select-sm">
                    ...
                    <option value="productGroupCode">그룹코드</option>
                    <option value="productGroupName">상품그룹명</option>
                </select>
            </div>
            <div class="col-md-2">
                <div class="row">
...
<div id="registerProductGroup" class="modal fade" tabindex="-1" data-bs-backdrop="static" role="dialog"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row m-auto p-1">
                    ...
                    <input type="text" id="productGroupName" class="form-control form-control-sm col" value="">
                </div>
                <div class="row m-auto p-1">
                ...
                <div class="row m-auto ">
                    <div class="row m-auto p-1">
                        ...
                        <select id="category" class="form-select form-select-sm col">
                            <option value="0" selected>카테고리 선택</option>
                        </select>
                    </div>
                    <div class="row m-auto p-1 table-responsive" style="max-height: 300px">
                        <table class="table table-sm table-hover table-bordered text-nowrap" style="width:100%"
                               id="productTable">
                            <thead>
                            <tr>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="registerProductGroupBtn">상품그룹등록</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row m-auto p-1">
                    <label for="productGroupName_e" class="col-form-label col-sm-3">상품그룹명</label>
                    <input type="text" id="productGroupName_e" class="form-control form-control-sm col" value="">
                </div>
            </div>
            <div class="modal-footer">
