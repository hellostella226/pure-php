    ...
    <div class="container-fluid table-responsive">
        <table class="table table-hover table-bordered text-nowrap sortable" style="width:100%">
            ...
            <tr>
                ...
                <th scope="col" data-column="ccm.ClientCustomerName"><button class="sort-btn">병원명<span aria-hidden="true"></span></button></th>
...
<script src="/b***-*abc/resources/js/abc/insureib.js"></script>